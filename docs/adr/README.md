...
Les ADR consignent les décisions structurantes d'ÉtymoLogique. Ils complètent la [vision du jeu](../game-design.md). Les choix de framework et de fournisseur n'arrivent qu'une fois les règles posées : ils sont consignés dans l'[ADR 0024](0024-architecture-logicielle-et-hebergement.md).
